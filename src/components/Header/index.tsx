            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="BabyOHM" width="32px" height="32px" />
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId &&
                      ...
                      chainId === ChainId.BSC && (
                        <>
                          <QuestionHelper text={i18n._(t`Add BabyOHM to your MetaMask wallet`)}>
                            <div
                              ...
                              onClick={() => {
                                if (library && library.provider.isMetaMask && library.provider.request) {
                                  const params: any = {
                                    type: 'ERC20',
                                    options: {
                                      address: '0xdfb392735e465760a17f2e31e63dff889aade8be',
                                      symbol: 'BabyOHM',
                                      decimals: 9,
                                      image: 'https://swap.babyolympus.co/logo.png',
                                    },
                                  }
                                  library.provider
                                    .request({
                                    ...
                                    .then((success) => {
                                      if (success) {
                                        console.log('Successfully added BabyOHM to MetaMask')
                                      } else {
