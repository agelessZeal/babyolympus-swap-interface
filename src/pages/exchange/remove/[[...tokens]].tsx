...
export default function Remove() {
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | BabyOHM</title>
        <meta key="description" name="description" content="Remove liquidity from the BabyOlympus AMM" />
      </Head>
                  ...
                  <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
                    ...
                    <div className="flex flex-col space-y-3 md:flex-row md:space-x-6 md:space-y-0">
                      <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-dark-900">
                        ...
                        <AutoColumn>
                          <div className="text-black">{formattedAmounts[Field.CURRENCY_A] || '-'}</div>
                      ...
                      <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-dark-900">
                        ...
                        <AutoColumn>
                          <div className="text-black">{formattedAmounts[Field.CURRENCY_B] || '-'}</div>
