  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">BabyOlympus</title>

        <meta
          key="description"
          name="description"
          content="Be a DeFi Chef with BabyOHM. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />

        <meta name="application-name" content="BabyOlympus App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="BabyOlympus App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="BabyOlympus App" />
        ...
        <meta key="twitter:creator" name="twitter:creator" content="@BabyOlympus" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="BabyOlympus App" />
